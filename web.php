...
<div class="container-fluid">
    <div class="row">
        ...
        <div id="sidebar">
            ...
            <nav id="nav">
                <ul>
                    <li><a  href="architecture.php"><i class="sprite sprite-sprite1"></i></a></li>
                    <li><a  href="web.php"><i class="sprite sprite-sprite2"></i></a></li>
                    <li><a  href="logo.php"><i class="sprite sprite-sprite3"></i></a></li>
                </ul>
            </nav>
            <!-- Recent Posts -->
